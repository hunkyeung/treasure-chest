...
public class MongoPageHelper {
     ...
     * String)
     */
    public <T extends Serializable> PageResult<T> pageQuery(Query query, Class<T> entityClass, Integer pageSize, Integer pageNum, String collectionName) {
    ...
    public <T, R extends Serializable> PageResult<R> pageQuery(Query query, Class<T> entityClass, Function<T, R> mapper, Integer pageSize, Integer pageNum, String collectionName) {
     ...
     */
    public <T, R extends Serializable> PageResult<R> pageQuery(Query query, Class<T> entityClass, Function<T, R> mapper, Integer pageSize, Integer pageNum, String lastId, String collectionName) {
        //分页逻辑
